          ...
          <div className='flex flex-col gap-6'>
            ...
            <div className='rounded-xl border border-slate-200 bg-slate-50 p-6'>
              <div className='mb-4 flex items-center gap-3'>
                ...
                <h3 className='text-lg font-semibold text-slate-800'>Alamat</h3>
              </div>
              ...
              <Button
                ...
                <Link href='mailto:humas@polinela.ac.id'>
                  ...
                  <div className='min-w-0 text-left'>
                    ...
                    <p className='font-medium text-sm sm:text-base whitespace-normal break-all sm:break-words'>
                ...
                <Link href='mailto:jurusanperikanandankelautan@polinela.ac.id'>
                  ...
                  <div className='min-w-0 text-left flex-1 break-words'>
                    <p className='text-xs text-slate-500'>
                      E-mail Jurusan Perikanan dan Kelautan
                    </p>
                    <p className='font-medium text-[13px] sm:text-base whitespace-normal break-all sm:break-words'>
                      jurusanperikanandankelautan@polinela.ac.id
                    </p>
                  </div>
                </Link>
              </Button>
            ...
            <div className='relative flex w-full min-h-[320px] items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-slate-100'>
              ...
              <div className='absolute inset-0 opacity-30'>
                <svg className='h-full w-full' viewBox='0 0 400 400'>
                  ...
                  />
                  <path
                    d='M 50 50 Q 150 100 200 200'
                    fill='none'
                    stroke='#e2e8f0'
                    strokeWidth='4'
                  />
                  <path
                    d='M 350 350 Q 250 300 200 200'
                    fill='none'
                    stroke='#e2e8f0'
                    strokeWidth='4'
                  />
              ...
              {/* View on Maps Link */}
              <a
                href='https://maps.app.goo.gl/NSGfHau8VVoVn6tb6'
                target='_blank'
