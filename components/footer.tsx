      ...
      <div className='mx-auto max-w-7xl px-4 pt-16 pb-8 lg:px-8 relative z-10'>
        <div className='grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4'>
          ...
          <div className='space-y-6'>
            <Link href='/' className='flex items-center gap-3 group'>
              ...
              <div>
                <span className='block text-xl font-extrabold text-white tracking-wider'>
                  DOLPHIN
                </span>
            ...
            <p className='text-sm leading-relaxed text-slate-400 text-justify'>
              Digital Operational Laboratory for Harmonized Integrated
              Navigation. Pusat inovasi, pendidikan, dan penelitian terdepan di
              bidang perikanan Politeknik Negeri Lampung.
            </p>
            <div className='flex gap-4 pt-2'>
              <a
                href='#'
                className='p-2.5 bg-slate-800 rounded-lg text-slate-400 hover:text-white hover:bg-pink-600 hover:shadow-lg hover:shadow-pink-600/20 transition-all duration-300'>
                <Instagram size={18} />
              </a>
              <a
                href='#'
                className='p-2.5 bg-slate-800 rounded-lg text-slate-400 hover:text-white hover:bg-red-600 hover:shadow-lg hover:shadow-red-600/20 transition-all duration-300'>
                <Youtube size={18} />
              </a>
              <a
                ...
                className='p-2.5 bg-slate-800 rounded-lg text-slate-400 hover:text-white hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-600/20 transition-all duration-300'>
                <Globe size={18} />
              </a>
            </div>
          </div>
            ...
            <ul className='space-y-4 text-sm text-slate-400 font-medium'>
              ...
              <li className='flex items-start gap-3 group'>
                ...
                <div className='flex flex-col gap-1 mt-0.5'>
                  <a
                    href='mailto:humas@polinela.ac.id'
                    className='hover:text-blue-400 transition-colors'>
                    humas@polinela.ac.id
                  </a>
                  <a
                    href='mailto:jurusanperikanandankelautan@polinela.ac.id'
                    className='hover:text-blue-400 transition-colors line-clamp-1'
                    title='jurusanperikanandankelautan@polinela.ac.id'>
        ...
        <div className='mt-16 pt-8 border-t border-slate-800/60 flex flex-col md:flex-row items-center justify-between gap-4'>
          <p className='text-sm text-slate-500 font-medium'>
            ...
            <span className='text-slate-300'>{APP_VERSION_LABEL}</span>. Hak
            Cipta Dilindungi.
          </p>
